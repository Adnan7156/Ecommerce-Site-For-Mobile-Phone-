...
$categories=$_categorie->trash_index();
?>
...
<html lang="en">
  ...
  <body>
    <?php include_once("../element/body.php")?>
...
<div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <a href="restore.php?id=<?=$categories['id']?>">Restore</a> |
      <a href="delete.php?id=<?=$categories['id']?>">Delete</a> 
