...
$query="SELECT * FROM `popular_tag`WHERE is_deleted=0";
...
<div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="show.php?id=<?=$popular_tag['id']?>">Show</a> |
      <a href="edit.php?id=<?=$popular_tag['id']?>"> Edit </a> |
      <a href="trash.php?id=<?=$popular_tag['id']?>">Trash</a></td>
