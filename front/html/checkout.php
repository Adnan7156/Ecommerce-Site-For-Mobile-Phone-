    ...
    <div class="col-md-6 border"> 
      <div class="login">
        ...
        <form>
          ...
          <button type="submit" class="btn btn-primary btn-block">Submit</button> <!-- Using btn-block to make button full-width -->
          <div class="text-center mt-2"> <!-- Centering and adding margin top -->
            <span class="psw">
